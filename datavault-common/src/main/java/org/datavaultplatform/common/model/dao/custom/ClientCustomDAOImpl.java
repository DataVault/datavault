...
@Repository
public class ClientCustomDAOImpl implements ClientDAO {

    private static final Logger logger = LoggerFactory.getLogger(ClientCustomDAOImpl.class);

    private final SessionFactory sessionFactory;

    public ClientCustomDAOImpl(SessionFactory sessionFactory) {
