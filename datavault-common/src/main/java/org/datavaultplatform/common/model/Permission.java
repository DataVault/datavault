...
public enum Permission {
    ...
    // School permissions
    CAN_VIEW_VAULTS_SIZE("CAN_VIEW_VAULTS_SIZE", PermissionModel.PermissionType.SCHOOL, "Admin view vault size", RoleName.ROLE_ADMIN, true),
    CAN_VIEW_IN_PROGRESS("CAN_VIEW_IN_PROGRESS", PermissionModel.PermissionType.SCHOOL, "Admin view transfers", RoleName.ROLE_ADMIN, true),
    CAN_VIEW_QUEUES("CAN_VIEW_QUEUES", PermissionModel.PermissionType.SCHOOL, "Admin view school queues", RoleName.ROLE_ADMIN, true),
    CAN_MANAGE_VAULTS("CAN_MANAGE_VAULTS", PermissionModel.PermissionType.SCHOOL, "Administer school vaults", RoleName.ROLE_ADMIN_VAULTS, true),
    CAN_MANAGE_DEPOSITS("CAN_MANAGE_DEPOSITS", PermissionModel.PermissionType.SCHOOL, "Administer school deposits", RoleName.ROLE_ADMIN_DEPOSITS, true),
    CAN_VIEW_RETRIEVES("CAN_VIEW_RETRIEVES", PermissionModel.PermissionType.SCHOOL, "Admin view school retrievals", RoleName.ROLE_ADMIN_RETRIEVES, true),
    CAN_VIEW_SCHOOL_ROLE_ASSIGNMENTS("CAN_VIEW_SCHOOL_ROLE_ASSIGNMENTS", PermissionModel.PermissionType.SCHOOL, "Admin view school role assignments", RoleName.ROLE_ADMIN_SCHOOLS, true),
    ...
    CAN_MANAGE_SCHOOL_ROLE_ASSIGNMENTS("CAN_MANAGE_SCHOOL_ROLE_ASSIGNMENTS",PermissionModel.PermissionType.ADMIN, "Manage school role assignments", RoleName.ROLE_ADMIN_SCHOOLS, true),
    CAN_MANAGE_REVIEWS("CAN_MANAGE_REVIEWS", PermissionModel.PermissionType.ADMIN, "Manage Reviews", RoleName.ROLE_ADMIN_REVIEWS, true);
