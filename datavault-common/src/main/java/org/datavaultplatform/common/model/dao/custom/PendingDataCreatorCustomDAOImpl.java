...
@Repository
public class PendingDataCreatorCustomDAOImpl implements PendingDataCreatorDAO {

    private static final Logger LOGGER = LoggerFactory.getLogger(PendingDataCreatorCustomDAOImpl.class);

    private final SessionFactory sessionFactory;

    public PendingDataCreatorCustomDAOImpl(SessionFactory sessionFactory) {
