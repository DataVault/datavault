...
@Repository
public class DataManagerCustomDAOImpl implements DataManagerDAO {

    private static final Logger logger = LoggerFactory.getLogger(DataManagerCustomDAOImpl.class);

    private final SessionFactory sessionFactory;

    public DataManagerCustomDAOImpl(SessionFactory sessionFactory) {
