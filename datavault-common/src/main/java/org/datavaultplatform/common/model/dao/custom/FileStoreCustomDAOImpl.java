...
@Repository
public class FileStoreCustomDAOImpl implements FileStoreDAO {

    private static final Logger logger = LoggerFactory.getLogger(FileStoreCustomDAOImpl.class);

    private final SessionFactory sessionFactory;

    public FileStoreCustomDAOImpl(SessionFactory sessionFactory) {
