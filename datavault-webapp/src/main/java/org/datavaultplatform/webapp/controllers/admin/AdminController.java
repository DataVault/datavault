...
public class AdminController {
    ...
    public String adminIndex(ModelMap modelMap, Principal principal) {
        ...
        if (permissionsModel.hasPermission(Permission.CAN_VIEW_VAULTS_SIZE)) {
            ...
            modelMap.addAttribute("vaultsize", DataVaultFileUtils.getGibibyteSizeStr(getVaultSize()));
        }
        ...
        if (permissionsModel.hasPermission(Permission.CAN_MANAGE_PENDING_VAULTS)) {
