...
public class AdminPendingVaultsController implements AdminPendingVaultsControllerApi {
    ...
    public String getPendingVaultForm(ModelMap model, @PathVariable String vaultId) {
    ...
    public String submitPendingVault(@ModelAttribute CreateVault vault, ModelMap model, @RequestParam String action,
                                   Principal principal) {
