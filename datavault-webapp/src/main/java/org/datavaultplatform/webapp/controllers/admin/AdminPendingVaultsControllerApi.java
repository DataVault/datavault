...
public interface AdminPendingVaultsControllerApi {
    ...
    String getPendingVaultForm(ModelMap model, @PathVariable String vaultId);
    ...
    String getVaultSummary(ModelMap model, @PathVariable("pendingVaultId") String vaultID, Principal principal);
    ...
    String submitPendingVault(@ModelAttribute CreateVault vault, ModelMap model, @RequestParam String action,
                            Principal principal);
