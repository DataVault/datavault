            ...
            <div class="container">
                ...
                <div class="panel panel-uoe-low">
                    <div class="panel-body">
                        <h2>Billing Details (Budget): <small>
                                ${billingDetails.vaultName?html}
                            </small></h2>
                        <br />
                        <table class="table table-sm">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <#if billingDetails.getSchool()??>
                                            ${billingDetails.school?html}
                                            <#else>
                                        </#if>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <#if billingDetails.getSubUnit()??>
                                            ${billingDetails.subUnit}
                                            <#else>
                                        </#if>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <#if billingDetails.getAmountToBeBilled()??>
                                            ${billingDetails.getAmountToBeBilled()?html}
                                            <#else>
                                        </#if>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <#if billingDetails.getAmountBilled()??>
                                            ${billingDetails.getAmountBilled()?html}
                                            <#else>
                                        </#if>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <#if billingDetails.getPaymentDetails()??>
                                            ${billingDetails.getPaymentDetails()?html}
                                            <#else>
                                        </#if>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <#if billingDetails.getSpecialComments()??>
                                            ${billingDetails.getSpecialComments()?html}
                                            <#else>
                                        </#if>
                                    </td>
                                </tr>
                                    ...
                                    <form id="update-billingDetails-form" class="form" role="form" action="${springMacroRequestContext.getContextPath()}/admin/billing/updateBillingDetails" method="post">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="${spring.status.expression}"
                                                    value="${spring.status.value!""}" id="amountToBeBilled" maxlength="400" pattern="[0-9]
+(\.[0-9]
[0-9]?)?" />
                                            </div>
                                            <div class="form-group">
...
+(\.[0-9]
[0-9]?)?" name="${spring.status.expression}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" class="form-control" name="${spring.status.expression}"
                                                    value="${spring.status.value!""}" id="comments" rows="4" cols="60" maxlength="400">
                                                    <#if billingDetails.getSpecialComments()??>
