...
import org.datavaultplatform.webapp.config.trace.MdcRestorationFilter;
...
class HttpSecurityUtilsTest {
    ...
    void testHttpSecurityConfig(boolean isStandalone) throws Exception {
        ...
        HttpSecurityUtils.authorizeRequests(http, isStandalone, traceLoggingFilter, mdcRequestFilter);
