...
insert into RetentionPolicies (id, name, engine, description, sort) values ('BBSRC', 'BBSRC', 'org.datavaultplatform.common.retentionpolicy.impl.uk.BBSRCRetentionPolicy', 'Vaults are due for review ten years after the date the last deposit was made.', 2);
insert into RetentionPolicies (id, name, engine, description, sort) values ('CRUK', 'Cancer Research UK', 'org.datavaultplatform.common.retentionpolicy.impl.uk.CancerResearchRetentionPolicy', 'Vaults are due for review five years after the date the last deposit was made.', 3);
insert into RetentionPolicies (id, name, engine, description, sort) values ('EPSRC', 'EPSRC', 'org.datavaultplatform.common.retentionpolicy.impl.uk.EPSRCRetentionPolicy', 'Vaults are due for review ten years after the date of the last retrieve event or the data the last deposit was made, whichever is the latter.', 4);
insert into RetentionPolicies (id, name, engine, description, sort) values ('5MIN', '5 minute test policy', 'org.datavaultplatform.common.retentionpolicy.impl.FiveMinuteRetentionPolicy', 'Test policy that flags for review any vault over 5 minutes old.', 5);
