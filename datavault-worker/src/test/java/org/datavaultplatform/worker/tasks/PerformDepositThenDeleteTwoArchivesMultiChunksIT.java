...
@SpringBootTest(classes = {
        ...
        PerformDepositThenDeleteTwoArchivesMultiChunksIT.TestConfig.class
})
@Slf4j
@AddTestProperties
@TestPropertySource(properties = "chunking.size=20MB")
class PerformDepositThenDeleteTwoArchivesMultiChunksIT extends BasePerformDepositThenDeleteTwoArchivesIT {
