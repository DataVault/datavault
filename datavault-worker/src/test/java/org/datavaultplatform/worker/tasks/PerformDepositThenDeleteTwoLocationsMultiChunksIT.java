...
@SpringBootTest(classes = {
        ...
        PerformDepositThenDeleteTwoLocationsMultiChunksIT.TestConfig.class
})
@Slf4j
@AddTestProperties
@TestPropertySource(properties = "chunking.size=20MB")
class PerformDepositThenDeleteTwoLocationsMultiChunksIT extends BasePerformDepositThenDeleteTwoLocationsIT {
