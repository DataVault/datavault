...
@SpringBootTest(classes = {
        ...
        PerformDepositThenDeleteTwoLocationManyMultiChunksIT.TestConfig.class
})
@Slf4j
@AddTestProperties
@TestPropertySource(properties = "chunking.size=500KB")
class PerformDepositThenDeleteTwoLocationManyMultiChunksIT extends BasePerformDepositThenDeleteTwoLocationsIT {
