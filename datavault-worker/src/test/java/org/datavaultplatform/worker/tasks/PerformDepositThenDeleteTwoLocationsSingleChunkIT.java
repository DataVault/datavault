...
@SpringBootTest(classes = {
        ...
        PerformDepositThenDeleteTwoLocationsSingleChunkIT.TestConfig.class
})
@Slf4j
@AddTestProperties
@TestPropertySource(properties = "chunking.size=60MB")
class PerformDepositThenDeleteTwoLocationsSingleChunkIT extends BasePerformDepositThenDeleteTwoLocationsIT {
