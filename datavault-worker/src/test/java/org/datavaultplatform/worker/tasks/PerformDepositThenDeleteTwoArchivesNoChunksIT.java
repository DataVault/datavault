...
@SpringBootTest(classes = {
        ...
        PerformDepositThenDeleteTwoArchivesNoChunksIT.TestConfig.class
})
@Slf4j
@AddTestProperties
@TestPropertySource(properties = {"chunking.enabled=false","chunking.size=0"})
@Ignore
class PerformDepositThenDeleteTwoArchivesNoChunksIT extends BasePerformDepositThenDeleteTwoArchivesIT {
