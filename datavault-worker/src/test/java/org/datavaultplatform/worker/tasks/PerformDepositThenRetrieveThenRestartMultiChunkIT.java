...
@SpringBootTest(classes = {
        ...
        PerformDepositThenRetrieveThenRestartMultiChunkIT.TestConfig.class
})
@Slf4j
@AddTestProperties
@TestPropertySource(properties = "chunking.size=20MB")
public class PerformDepositThenRetrieveThenRestartMultiChunkIT extends BasePerformDepositThenRetrieveThenRestartIT {
