...
@SpringBootTest(classes = {
        ...
        PerformDepositThenDeleteTwoLocationsNoChunksIT.TestConfig.class
})
@Slf4j
@AddTestProperties
@TestPropertySource(properties = {"chunking.enabled=false","chunking.size=0"})
class PerformDepositThenDeleteTwoLocationsNoChunksIT extends BasePerformDepositThenDeleteIT {
