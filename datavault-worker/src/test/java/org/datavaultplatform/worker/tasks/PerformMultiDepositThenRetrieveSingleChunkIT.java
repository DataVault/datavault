...
@SpringBootTest(classes = {
        ...
        PerformMultiDepositThenRetrieveSingleChunkIT.TestConfig.class
})
@Slf4j
@AddTestProperties
@TestPropertySource(properties = "chunking.size=60MB")
public class PerformMultiDepositThenRetrieveSingleChunkIT extends BaseMultiPerformDepositThenRetrieveIT {
