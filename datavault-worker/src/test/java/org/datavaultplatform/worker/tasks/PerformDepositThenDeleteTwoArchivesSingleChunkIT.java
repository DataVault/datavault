...
@SpringBootTest(classes = {
        ...
        PerformDepositThenDeleteTwoArchivesSingleChunkIT.TestConfig.class
})
@Slf4j
@AddTestProperties
@TestPropertySource(properties = "chunking.size=60MB")
class PerformDepositThenDeleteTwoArchivesSingleChunkIT extends BasePerformDepositThenDeleteTwoArchivesIT {
