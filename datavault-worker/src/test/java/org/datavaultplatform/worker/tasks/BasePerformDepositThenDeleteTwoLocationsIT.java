...
@Slf4j 
abstract class BasePerformDepositThenDeleteTwoLocationsIT extends BaseDepositTwoLocationsIT implements DepositThenDelete {
  ...
  public List<ArchiveStoreInformation> getArchiveStoreInformation() {
    return List.of(
            new ArchiveStoreInformation(MultiLocalFileSystem.class, "ARCHIVE-STORE-DST-ID", List.of(destDir1.getAbsolutePath(), destDir2.getAbsolutePath()))
    );
  }
