 ...
 * there was an 'integer overflow' error when the data written to tar file reached 1TB.
...
public class DatavaultTarArchiveOutputStream extends ArchiveOutputStream {
  ...
  /**
   * Constructor for DatavaultTarArchiveOutputStream.
   *
   * <p>Uses a block size of 512 bytes.</p>
   *
   * @param os the output stream to use
   */
  public DatavaultTarArchiveOutputStream(final OutputStream os) {
   ...
   * @since 1.4
   */
  public DatavaultTarArchiveOutputStream(final OutputStream os, final String encoding) {
   ...
   */
  public DatavaultTarArchiveOutputStream(final OutputStream os, final int blockSize) {
   ...
   * @throws IllegalArgumentException if the {@link DatavaultTarArchiveOutputStream#longFileMode} equals
   *                                  {@link DatavaultTarArchiveOutputStream#LONGFILE_ERROR} and the file
   *                                  name is too long
   * @throws IllegalArgumentException if the {@link DatavaultTarArchiveOutputStream#bigNumberMode} equals
   *         {@link DatavaultTarArchiveOutputStream#BIGNUMBER_ERROR} and one of the numeric values
