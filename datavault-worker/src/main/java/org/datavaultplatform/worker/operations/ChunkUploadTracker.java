...
@Slf4j
public record ChunkUploadTracker(ArchiveStoresDepositedFiles archiveStoresDepositedFiles, int chunkNumber, File chunk, Map<String, ArchiveStore> archiveStores,
                                 String depositId, UserEventSender userEventSender, String jobID) implements Callable<HashMap<String, String>> {
